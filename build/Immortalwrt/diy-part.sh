...
# git clone https://github.com/y9858/luci-theme-opentomcat.git package/luci-theme-opentomcat
...
export Op_name="OpenWrt-SE"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
#export Mandatory_theme="opentomcat" 
#export Default_theme="opentomcat"   
